...
const Slack = () => {
  return (
    <div className="w-full border shadow">
      <div className="flex">
        <div className="bg-gray-500 text-purple-lighter w-1/5 pb-6 hidden md:block">
        ...
        <div className="w-full flex flex-col">
          ...
          <div className="px-6 py-4 flex-1 overflow-scroll-x">
            ...
            <div className="flex items-start">
              <img src="https://i.imgur.com/qACoKgY.jpg" className="w-10 h-10 rounded mr-3" alt="" />
              <div className="flex flex-col">
                <div className="flex items-end">
                ...
                <p className="font-light text-md text-grey-darkest pt-1">
                  ...
                  stop adding more utilities before its too late!
                </p>
              </div>
            </div>
          </div>
